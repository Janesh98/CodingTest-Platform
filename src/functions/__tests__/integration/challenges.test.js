...
describe('/newChallenge', () => {
  ...
  it('POST /, should add a new challenge and set timeout to 15 as value lower than 15', async () => {
    const mockData = {
      data: {
        googleId: '123',
          testName: 'the test',
...
describe('/updateChallenge', () => {
  ...
  it('POST /, should update an existing challenge and set timeout to 15 as value lower than 15', async () => {
    const mockData = {
      data: {
        googleId: '123',
          testName: 'the test',
