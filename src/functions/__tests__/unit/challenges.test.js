...
describe('/newChallenge', () => {
  ...
  it('POST /, should post a new challenge and set timeout to 15 as time in data is lower', async () => {
    let responseObject = {};
    let status = null;
    const mockData = { _id: '123' };
    await jest
...
describe('/updateChallenge', () => {
  ...
  it('POST /, should update challenge and set timeout to 15 as time in data is lower', async () => {
    let responseObject = {};
    let status = null;
    const req = {
      body: {
