...
describe('setup and edit tests', () =>{
    it('login user create, setup test, edit test and logout', () => {
        ...
        cy.wait(5000);
        cy.get('[data-testid="Problem Description"]').type('{backspace}{backspace}{backspace}{backspace}{backspace}{backspace}{backspace}{backspace}{backspace}{backspace}{backspace}{backspace}{backspace}{backspace}{backspace}{backspace}{backspace}{backspace}{backspace} from sys.argv and print to stdout');
        cy.get('[data-testid="save"]').click()
        cy.wait(5000);
